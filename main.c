...
void Body(void) {  // пока не дописано WinData,Render9
  ...
  Print((Base.Colours == 1) ? Ink(0) : Ink(3), aB, b); snprintf(b, 100, "%lu %lu %lu %lu:%lu:%lu                         ", Base.Din, Base.Sap, Base.Sam, Base.Hor, Base.Kal, Base.Vik);
...
void Init(void) { Fresh(11, 1, 999, Off, 500, 250); Colour(15, 24); Planet(24, 60, 60, 400, 146097); Date(2026, 7, 6); Time(16, 20); SetPalette(On); Keys(K_ESC);
