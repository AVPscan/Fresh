...
void Init(void) { Fresh(11, 999, Off, 500, 250); Colour(179, 24); Keys(K_ESC); Even(' ', Timer, K_ALT_TAB, K_ALT_ENT); Exec(Space, Tim, WDown, WUp);
  ugoc control = Window(On, Ink(7), -2, -2), W1 = Window(Off, On + Rand(Base.Colours + On), Off, Off, 80, 24); WSet(W1, On, On); WView(W1, On, On); VP.Wexe = W1;
