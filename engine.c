...
void Show(void) {
  ...
  snprintf(Cvdat, 100, "\nx%d y%d wx%d wy%d xy%d                      ", VP.X, VP.Y, VP.X + VP.viewX, VP.Y + VP.viewY, VP.dXY); if (StrLen(Cvdat) >= c) *(Cvdat + c + 1) = 0;
