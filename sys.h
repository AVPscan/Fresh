...
typedef struct { ugoc W, H, CW, CH, MaS, MiS, Speed; uint16_t MW, Win, Min, Max, D, S, Timer[5], Start[5];
...
enum {
    ...
    SizeVram = SDCell + SInfo + SDs + SFon + SPal + SKeys + 2 * (SOffset + SVsw + SCsw + SWin + SConvas) + SEvent + SExec + SBuf,
