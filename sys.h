...
/*
4 X Y   вывод (0 0 привязка окна к холсту(не отображается) иначе >0 привязка к левому верхнему углу холста 0< привязка по модулю к левому верхнему углу окна вьюпорта)
