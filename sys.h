...
/*
4 X Y   вывод (0 0 привязка окна к холсту, если >0 привязка к левому верхнему иначе (0<) привязка по модулю к правому нижнему углу окна вьюпорта)
4 c r   размер ширина и высота (0 безразмерна иначе визуальная ширина окна если r<0 то теневое окно)
4 Xc Yc смещение от начала окна, организация прокрутки вертикальной и горизонтальной в любом направлении
4 Xk Yk координаты курсора внутри окна
4 cvmax clmax максимальная визуальная ширина строки окна и максимальная ширина строки окна в байтах
1 k	корень - окно родитель значит совпадает с номером окна, иначе номер окна родителя
...
1 data	3 бита: 7 - запрет авто переноса строк; 6 - включить статику окна; 5 - отключить отображение курсора окна, 4 - теневое окно
