...
Теперь Вам доступна реальная возможность увидеть расхождение частоты электоросети, если таймер отстаёт от времени в оси! GlobalSet(16, Off, 2000, 500, 250) - скорректируйте предпоследнее число, в примере это 500 для России `частота сети * 10`, чтоб время не отставало...
