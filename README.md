...
Теперь Вам доступна реальная возможность увидеть расхождение частоты электоросети, если таймер отстаёт от времени в оси! SysSet(500, 1000, 24, 15, 10) - скорректируйте первое число, в примере это 500 для России `частота сети * 10`, чтоб время не отставало...
